# This script takes the merged record files for each database (currently Scopus, WoS, and PubMed) generated by
# corpusDBMerge.py and merges them into one Bibliometrix file for analysis.
